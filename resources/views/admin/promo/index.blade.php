...
@section('styles')
<link rel="stylesheet" href="{{ asset('public/backend/js/plugins/jquery-tags-input/jquery.tagsinput.min.css') }}">
...
<div class="content">
    <div class="content-heading pt-0 mb-3">
        Kelola Promo
        <a href="{{ route('admin.promo.tambah') }}" class="btn btn-secondary mr-5 mb-5 float-right btn-rounded">
...
<script src="{{ asset('public/js/admin/promo/promo.js') }}"></script>
@endpush
