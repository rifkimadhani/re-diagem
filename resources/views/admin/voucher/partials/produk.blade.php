<div class="block-content">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="form-group row">
                <label class="col-lg-3 control-label" for="bn-add_produk">Produk Yang Berlaku</label>
                <div class="col-lg-9">
                    <button class="btn btn-primary" id="btn-add_produk" type="button" data-toggle="modal" data-target="#modalAddproduk">
                        <i class="si si-plus mr-2"></i> Tambahkan Produk
                    </button>
                </div>
            </div>
        </div>
