<aside id="sidebarHeader" class="u-sidebar u-sidebar--left w-90" aria-labelledby="sidebarHeaderInvoker">
            ...
            <div class="u-header-sidebar__footer-offset">
                ...
                <div class="js-scrollbar u-sidebar__body">
                    <div id="headerSidebarContent" class="u-sidebar__content u-header-sidebar__content">
                        <!-- Logo -->
                        <a class="max-width-180 navbar-brand" href="{{ url('/') }}" aria-label="Asoy Mart">
                            <img src="{{ asset('assets/media/logo/logo.png') }}" class="img-fluid"/>
                        </a>
                        <!-- End Logo -->
